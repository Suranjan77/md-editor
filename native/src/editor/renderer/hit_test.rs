...
pub(crate) fn get_image_number(span: &crate::editor::highlight::StyledSpan) -> Option<usize> {
...
pub(crate) fn is_heading_line(line: &crate::editor::highlight::StyledLine) -> bool {
    line.spans
        .iter()
        .any(|span| span.is_syntax && span.visible_text(true).starts_with('#'))
}

pub(crate) fn is_checkbox_line(line: &crate::editor::highlight::StyledLine) -> bool {
    line.spans.iter().any(|span| span.is_checkbox)
}

pub(crate) fn is_pdf_citation_line(line: &crate::editor::highlight::StyledLine) -> bool {
    line.spans
        .iter()
