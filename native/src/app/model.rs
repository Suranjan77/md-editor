...
pub(crate) const PDF_RENDER_SUPERSAMPLE: f32 = 2.0;
pub(crate) const PDF_RENDER_PRELOAD_PAGES: u16 = 3;
pub(crate) const PDF_RENDER_MAX_SCHEDULED_PAGES: u16 = 64;
pub(crate) const PDF_TEXT_PAGE_CACHE_LIMIT: usize = 50;
...
mod tests {
    ...
    fn split_view_places_pdf_before_markdown() {
        let source = include_str!("model.rs").replace("\r\n", "\n");
