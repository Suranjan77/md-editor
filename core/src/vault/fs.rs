//! Filesystem-backed vault operations (P2.T2): scan/CRUD plus index and
//! search-repository upkeep. `application::VaultService` is the public entry
//! point; these functions are its internals.

use std::fs;
use std::path::{Path, PathBuf};

use crate::database::search_repository::SearchRepository;
use crate::domain::{BacklinkItem, BacklinkTarget, FileEntry};
